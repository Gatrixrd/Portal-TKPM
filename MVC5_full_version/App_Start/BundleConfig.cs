    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      ...
                      "~/Content/morris.css",
                      "~/Content/animate.css",
                      "~/Content/assets/plugins/icheck/css/all.css",
                      "~/Content/assets/css/Montserrat.css",
                      "~/Content/assets/css/Montserrat.css",
                      "~/Content/main.css"));

            bundles.Add(new ScriptBundle("~/bundles/Fechas").Include(
            "~/Scripts/src/Calendario.js"));
            bundles.Add(new ScriptBundle("~/bundles/monedas").Include(
           "~/Scripts/jquery.price_format.2.0.js"));
            ...
            #region      Se agrega para ampliar funcionalidades tipo BAFAR
            ...
            bundles.Add(new StyleBundle("~/Content/kendo/flat").Include(
            "~/Content/kendo/kendo.common.min.css",
            "~/Content/kendo/kendo.flat.min.css",
            "~/Content/kendo/kendo.mobile.all.min.css"));

            bundles.Add(new StyleBundle("~/Content/bafar/jquery-ui-CSS").Include(
            "~/Content/bafar/jquery-ui.min.css"));
            ...
            bundles.Add(new ScriptBundle("~/bundles/appBafar").Include(
           "~/Scripts/src/appBafar.js"));

            #endregion Se agrega para ampliar funcioanlidades tipo BAFAR
