...
namespace MVC5_full_version.Controllers.FacturasSAXML
{
    public class facturasSAXMLController : Controller
    {
        ...
        public ActionResult CompararImportes(List<ClickFactura_Entidades.BD.Modelos.Registros> registros)
        {
            try
            {
                ...
                //foreach(ClickFactura_Entidades.BD.Modelos.Registros _reg in registros)
                //{
        ...
        public ActionResult GenerarPasivo()
        {
            ...
            KeyValuePair<string, string> _agregar = new KeyValuePair<string, string>("msg1", "Antes de Generar Pasivo.");
            ...
            try
            {
                ...
                _agregar = new KeyValuePair<string, string>("msg2", "Generar Pasivo.");
                resultados2.Add(_agregar);
